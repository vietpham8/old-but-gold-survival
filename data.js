...
const scenarios = {
    ...
    financial: { name: "💰 Khủng hoảng Tiền mặt", color: "purple", desc: "Hết tiền mặt, không chuyển khoản, mất thẻ/ví" },
    financialEmergency: { name: "🔐 Kế thừa Tài chính", color: "emerald", desc: "Người quản lý tài chính mất khả năng, gia đình không truy cập tài sản/nợ" },
